...
public:
	...
	// 20	not initialized, only by descendant to -1.0! flt020 gets set to GameHour minus one on package evaluation
	UInt32 iDateLastProcessed; // 24	not initialized, only by descendant!
	UInt32 uiProcessLevel;
	// 28	not initialized, only by descendant to 3 for Low, 2 for MidlleLow, 1 MiddleHighProcess and 0 for HigProcess
